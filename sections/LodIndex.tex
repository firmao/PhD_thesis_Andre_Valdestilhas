...
%
        \subfigure[Dataset Matching]{%
            ...
            \includegraphics[width=0.4\textwidth]{img/LaundromatDsMatch.png}
        }%
        \subfigure[Time Dataset Matching]{%
           \label{fig:time600Laundromat}
           \includegraphics[width=0.4\textwidth]{img/time.png}
        }
%
    \end{center}
